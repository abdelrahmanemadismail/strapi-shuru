...
export interface ApiConsultationConsultation
  ...
  info: {
    description: 'Consultation request form submissions';
  ...
  attributes: {
    ...
    preferredDateTime: Schema.Attribute.DateTime & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEmailTemplateEmailTemplate
  ...
  info: {
    description: 'Email templates for authentication and notification emails used by strapi-provider-email-extra';
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global footer settings for the application';
    displayName: 'Footer';
    pluralName: 'footers';
    singularName: 'footer';
  };
  ...
  attributes: {
    bottomLinks: Schema.Attribute.Component<'layout.navigation-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    darkLogoImage: Schema.Attribute.Media<'images'>;
    description: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    lightLogoImage: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    darkLogoImage: Schema.Attribute.Media<'images' | 'files'>;
    lightLogoImage: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::header.header'>;
    navigation: Schema.Attribute.Component<'layout.navigation-menu', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    publishedAt: Schema.Attribute.DateTime;
    topBar: Schema.Attribute.Component<'layout.top-bar', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMajlisMajlis extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    guests: Schema.Attribute.Component<'shared.guest', true>;
    is_featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::majlis.majlis'>;
...
export interface ApiSavedInsightSavedInsight
  extends Struct.CollectionTypeSchema {
  collectionName: 'saved_insights';
  info: {
    description: 'User saved/bookmarked insights';
    displayName: 'Saved Insight';
    pluralName: 'saved-insights';
    singularName: 'saved-insight';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    insightType: Schema.Attribute.Enumeration<
      ['article', 'news-item', 'magazine-issue', 'majlis', 'podcast']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::saved-insight.saved-insight'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::saved-insight.saved-insight': ApiSavedInsightSavedInsight;
